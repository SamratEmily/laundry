...
const TRUST_BADGES = [
  { icon: Clock, text: '15-Min Pickup', color: '#c9a84c' },
  { icon: Star, text: '5-Star Rated', color: '#c9a84c' },
  { icon: Shield, text: '100% Safe', color: '#c9a84c' },
]
    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-primary-gradient">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-16">
        ...
        >
          ...
          #1 Laundry Service in Makkah Al-Mukarramah
        </motion.div>
        ...
        >
          Fastest Laundry
          <br />
          <span className="text-gradient-gold">Pickup in Makkah</span>
        </motion.h1>
        ...
        >
          Fresh, clean clothes delivered to your hotel in{' '}
          <span className="text-[#e2c276] font-semibold">under 24 hours.</span>
          {' '}Serving pilgrims & residents across all major zones.
        </motion.p>
        ...
        >
          ...
          Guaranteed Pickup in Just 15 Minutes!
        </motion.div>
